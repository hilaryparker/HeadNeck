...
pretty_boxplot(y=list(predictor_results$none.out,predictor_results$dbonly.out,predictor_results$dbfsva.out),cols=cols,labs=c("No Correction","Training Set Only","Training and Test Set"))
```
